  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-4 sm:py-6 md:py-8">
      <div className="container-responsive">
        ...
        {/* Overall Score */}
        <div className={`${getScoreBgColor(statistics.accuracy)} dark:bg-opacity-20 rounded-lg p-4 sm:p-6 mb-4 sm:mb-6 border`}>
          <div className="text-center">
            <div className="flex items-center justify-center mb-3 sm:mb-4">
              {statistics.accuracy >= 80 ? (
                <svg className="w-8 h-8 sm:w-12 sm:h-12 text-green-600 dark:text-green-400 mr-2 sm:mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              ) : statistics.accuracy >= 60 ? (
                <svg className="w-8 h-8 sm:w-12 sm:h-12 text-yellow-600 dark:text-yellow-400 mr-2 sm:mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                </svg>
              ) : (
                <svg className="w-8 h-8 sm:w-12 sm:h-12 text-red-600 dark:text-red-400 mr-2 sm:mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              )}
              <div>
                <div className={`text-4xl sm:text-5xl md:text-6xl font-bold ${getScoreColor(statistics.accuracy)} mb-1 sm:mb-2`}>
        ...
        <div className="card-base mb-4 sm:mb-6">
          ...
          <div className="space-y-3 sm:space-y-4">
            {Object.entries(statistics.domainBreakdown).map(([domain, stats]) => (
              <div key={domain} className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3 sm:p-4">
                <div className="flex items-center justify-between mb-2 sm:mb-3">
                    ...
                    <div className="progress-bar">
                      <div
                        className={`progress-fill ${
                          stats.accuracy >= 80 ? 'bg-green-600' :
                  ...
                  <div className="ml-3 sm:ml-4 text-right">
                    <span className={`font-bold text-responsive-sm ${getScoreColor(stats.accuracy)}`}>
        ...
        <div className="card-base mb-6 sm:mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            <div className="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
              ...
              <div>
                <span className="text-responsive-xs text-gray-600 dark:text-gray-400 block">学習モード</span>
            ...
            <div className="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
              ...
              <div>
                <span className="text-responsive-xs text-gray-600 dark:text-gray-400 block">開始時刻</span>
                <span className="font-medium text-gray-900 dark:text-white text-responsive-sm">
            ...
            {statistics.averageTimePerQuestion && (
              <div className="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg sm:col-span-2">
                <svg className="w-5 h-5 text-purple-600 dark:text-purple-400 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
                <div>
                  <span className="text-responsive-xs text-gray-600 dark:text-gray-400 block">平均回答時間</span>
                  <span className="font-medium text-gray-900 dark:text-white text-responsive-sm">
        ...
        <footer className="mt-8 sm:mt-12 text-center">
          <p className="text-responsive-xs text-gray-500 dark:text-gray-400">
            学習を継続して、AWS CloudOps Engineer認定試験の合格を目指しましょう！
          </p>
        </footer>
      </div>
    </div>
