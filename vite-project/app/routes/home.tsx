  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900">
      <div className="container-responsive py-6 sm:py-8 md:py-12">
        ...
        {/* ドメイン別学習 */}
        <section className="card-base mb-8 sm:mb-12" aria-labelledby="domain-learning">
          <h3 id="domain-learning" className="text-responsive-lg font-semibold text-gray-900 dark:text-white mb-4 sm:mb-6">
            ドメイン別学習
          </h3>
          ...
          <div className="grid-responsive-3 gap-3 sm:gap-4">
            ...
            >
              <div className="flex-grow">
                ...
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">20% - CloudWatch, CloudTrail</p>
              </div>
            ...
            >
              <div className="flex-grow">
                ...
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">32% - Auto Scaling, ELB</p>
              </div>
              <div className="text-right">
            ...
            >
              <div className="flex-grow">
                ...
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">20% - CodeDeploy, CloudFormation</p>
              </div>
              <div className="text-right">
            ...
            >
              <div className="flex-grow">
                ...
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">16% - IAM, GuardDuty</p>
              </div>
              <div className="text-right">
            ...
            >
              <div className="flex-grow">
                ...
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">12% - VPC, Route Tables</p>
              </div>
              <div className="text-right">
        ...
        <section className="card-base" aria-labelledby="exam-info">
          <h3 id="exam-info" className="text-responsive-lg font-semibold text-gray-900 dark:text-white mb-4 sm:mb-6">
            試験について
          </h3>
